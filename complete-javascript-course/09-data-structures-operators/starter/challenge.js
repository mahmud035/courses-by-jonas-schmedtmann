...
const game = {
  ...
  printGoals: function (...players) {
    console.log(`${players.join(', ')} scored ${players.length} goals`);
  },
};
...
// The logical AND (&&) operator is used to check if team1's odds are less than team2's odds.
// If true, it returns team1; otherwise, it moves to the next condition.

// Similarly, the second condition checks if team1's odds are greater than team2's odds, and if true, it returns team2.

// The logical OR (||) operator ensures that if the first condition is false, it evaluates the second condition. */
...
const avgOdd = totalOdd / odds.length;
